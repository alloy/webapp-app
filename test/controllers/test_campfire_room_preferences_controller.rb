...
# 
# describe 'CampfireRoomPreferencesController' do
#   before do
#     @controller = CampfireRoomPreferencesController.alloc.init
#     
...
#     @controller.should.be.an.instance_of CampfireRoomPreferencesController
#   end
#   
